...
function We(o18, t14) {
  ...
  } }, { resolveContainers: S8, mainTreeNodeRef: re2, MainTreeNode: le4 } = j6({ portals: ee6, defaultContainers: [oe3] }), ne3 = C7 ? "parent" : "leaf", j11 = P7 !== null ? (P7 & d9.Closing) === d9.Closing : false, ae6 = (() => C7 || j11 ? false : v7)();
  T6({ allowed: o4(() => {
    var e7, g8;
...
function De6(t14, n13) {
  ...
  let Ce4 = v7 && !V6, ee6 = V6 && c13 && v7, te4 = (() => ee6 ? "enter" : !X3 || Ce4 ? "idle" : c13 ? "enter" : "leave")(), A7 = c12(0), he3 = o4((b7) => u2(b7, { enter: () => {
    var l16, u17;
